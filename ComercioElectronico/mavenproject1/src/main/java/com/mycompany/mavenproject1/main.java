...
public class main {
    ...
    public static void main(String[] args) {
        ...
        insertarLinea(miPedido, linea1, linea2, linea3);
    ...
    public static void descuento(pedido miPedido) {
    ...
    public static void insertarLinea(pedido miPedido, lineapedido linea1, lineapedido linea2, lineapedido linea3) {
